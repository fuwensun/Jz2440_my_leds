...
/* 这个结构时字符设备驱动程序的核心
 * 当应用程序操作设备文件时所调用的OPEN、RDAD、WRITE等函数
 * 最终会调用这个结构中指定的对应函数
 */

static struct file_operations s3c24xx_leds_fops= {
	.ower = THIS_MODULE,/*这是一个宏，指向编译模块时自动创建的__this_module 变量*/
 ...
 * 这样，主设备号就和具体的file_opetations结构联系起来了
 * 操作主设备为LED_MAJOR的设备文件，时就会调用s3c24xx_leds_fops中的相关成员函数
...
/*不是必须的*/
MODULE_AUTHOR("hhtp:www.100ask.net");
